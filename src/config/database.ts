...
export const initLocalDatabase = async () => {
  await db.execAsync(`
    ...
    CREATE TABLE IF NOT EXISTS clients (id TEXT PRIMARY KEY NOT NULL, businessName TEXT NOT NULL, address TEXT NOT NULL, defaultList TEXT NOT NULL DEFAULT 'list1', visitDay TEXT NOT NULL, phone TEXT, email TEXT, createdAt INTEGER NOT NULL, updatedAt INTEGER, syncStatus TEXT DEFAULT 'PENDING');
